...
function countChars(str) {
    const lowercaseNoSpacesStr = str.toLowerCase().split(" ").join("");
    const letterCount = {};
    for (let i = 0; i < lowercaseNoSpacesStr.length; i++) {
        let currentChar = lowercaseNoSpacesStr[i];
        if (!letterCount[currentChar]) {
            letter[currentChar] = 1
        } else {
...
console.log(countChars("Samuel Jackson"));
